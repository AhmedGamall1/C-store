...
// The `sizes` body field arrives as a JSON-encoded string (because multipart).
// If parsing fails, we let the array check raise the error.
const sizesJsonField = z.preprocess((v) => {
  ...
  try {
    ...
    return v // array check below will say "Expected array, received string"
  }
